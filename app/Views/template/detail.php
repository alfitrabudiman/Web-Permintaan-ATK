...
<div class="dashboard">
    ...
    <input type="hidden" id="id_header" name="id_header" value="<?= $_POST['id_header'] ?>" required>
    
    <label for="id_atk">Id ATK:</label><br>
    <input type="text" id="id_atk" name="id_atk" required><br>

    <label for="nama_atk">Nama ATK:</label><br>
    <input type="text" id="nama_atk" name="nama_atk" required><br><br>
