...
<div class="dashboard">
    ...
    <div class="main-content">
      ...
      <form action="proses_permintaan.php" method="post">
        <label for="nama">Id Karyawan:</label><br>
        <input type="text" id="Id karyawan" name="Id Karyawan" required><br>
        <label for="nama">Nama Karyawan:</label><br>
        <input type="text" id="Nama Karyawan" name="Nama Karyawan" required><br><br>
        <label for="nama">Id Departemen:</label><br>
        <input type="text" id="Id Departemen" name="Id Departemen" required><br>
